...
from .routes import user_routes, role_routes, manifest_routes, baggage_case, auth, fligths_manifest, email_service
...
app.include_router(email_service.router, prefix="/api/email")
